...
//-----------------------------------------------------
/**
 * The "settings.ini" file has on each line an alias for a rom
 * its path and indicates, and the number of opcodes to execute
 * per second while playing it.
 *
 * The file format is as follows:
 * RomName: PATH_TO_ROM_FILE, OPCODES_PER_SECOND!
 */
bool ecEmulate::LoadSettings(SETTINGS_MAP& settings)
{
...
//-----------------------------------------------------
bool ecEmulate::LoadRom(EightChipCPU* cpu, const SETTINGS_MAP& settings)
{
	bool res = false;
...
//-----------------------------------------------------
void ecGfx::DrawGraphics(EightChipCPU* cpu)
{
...
//-----------------------------------------------------
void ecEmulate::SetupInput(EightChipCPU* cpu, SDL_Event event)
{
	int key = -1;
	...
	if(event.type == SDL_KEYDOWN)
	{
		...
		{
			case SDLK_q: key = 0x0; break;
			case SDLK_s: key = 0x1; break;
			case SDLK_d: key = 0x2; break;
			case SDLK_f: key = 0x3; break;
			case SDLK_w: key = 0x4; break;
			case SDLK_x: key = 0x5; break;
			case SDLK_c: key = 0x6; break;
			case SDLK_v: key = 0x7; break;
			case SDLK_a: key = 0x8; break;
			case SDLK_z: key = 0x9; break;
			case SDLK_e: key = 0xA; break;
			case SDLK_r: key = 0xB; break;
			case SDLK_u: key = 0xC; break;
			case SDLK_i: key = 0xD; break;
			case SDLK_o: key = 0xE; break;
			case SDLK_p: key = 0xF; break;
...
//-----------------------------------------------------
void ecEmulate::EmulateCycle(EightChipCPU* cpu, const SETTINGS_MAP& settings, bool& status)
{
	status = true;
